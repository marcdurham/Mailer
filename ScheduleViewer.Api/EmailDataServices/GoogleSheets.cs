...
public class GoogleSheets : ISpreadSheetService
{
    ...
    private readonly ILogger<GoogleSheets> _logger;

    public GoogleSheets(IConfiguration configuration, ILogger<GoogleSheets> logger)
    {
        string jsonFile = configuration.GetValue<string>("GoogleApiSecretJsonFile");
